...
'step 3: Add visual checkpoint at Page category chekhly-na-iphone'

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Page Category Chekhly Na Iphone_visual_checkpoint')
